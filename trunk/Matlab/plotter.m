...
print -deps Erbium_gammel % Prints to eps file named 'Erbium_300grv-5s-1550nm-300k' for use in latex

% ############################################################
% Erbium referanseprøve ved 300K, grating på 300 og 5 sekunder
% integreringstid med pumping på 532nm gjennom 'nytt' oppsett
...
%Cryomålinger
figure(5);
title('Sample 4 ved 18K i et "bra område", belyst med 4.6mW ved 532nm, med grating på 300');
ylabel('Intensitet');
xlabel('Bølgelengde [nm]');
...
figure(10)
A = dlmread('C:\Documents and Settings\Jon\My Documents\Prosjekt\solcelle\nov-06-2009\MC Si - Sample 4\300grv-5s-900nm-23k',delimiter);
